...
class OracleSchemaManagerTest extends SchemaManagerFunctionalTestCase
{
    ...
    public function testListTableDetailsWithDifferentIdentifierQuotingRequirements()
    {
        ...
        $this->assertSame( array( '"select"' ),
            $onlinePrimaryTable->getIndex( 'from' )->getQuotedColumns( $platform ) );
        ...
        $this->assertSame( array( 'FOO' ),
            $onlinePrimaryTable->getIndex( 'foo_index' )->getQuotedColumns( $platform ) );
        ...
        $this->assertSame( array( 'BAR' ),
            $onlinePrimaryTable->getIndex( 'BAR_INDEX' )->getQuotedColumns( $platform ) );
        ...
        $this->assertSame( array( 'BAZ' ),
            $onlinePrimaryTable->getIndex( 'BAZ_INDEX' )->getQuotedColumns( $platform ) );
        ...
        $this->assertSame( array( '"Fk"' ),
            $onlineForeignTable->getIndex( '"Fk_index"' )->getQuotedColumns( $platform ) );
