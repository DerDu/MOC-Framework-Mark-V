...
class SqlitePlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testAlterTableAddComplexColumns()
    {
        ...
        $diff = new TableDiff( 'user' );
        $diff->addedColumns['time'] = new Column( 'time', Type::getType( 'date' ),
            array( 'default' => 'CURRENT_DATE' ) );
    ...
    public function testCreateTableWithDeferredForeignKeys()
    {
        ...
        $table->addForeignKeyConstraint( 'user', array( 'parent' ), array( 'id' ),
            array( 'deferrable' => true, 'deferred' => true ) );
    ...
    public function testAlterTable()
    {
        ...
        $diff->newName = 'client';
        $diff->renamedColumns['id'] = new \Doctrine\DBAL\Schema\Column( 'key',
            \Doctrine\DBAL\Types\Type::getType( 'integer' ), array() );
        $diff->renamedColumns['post'] = new \Doctrine\DBAL\Schema\Column( 'comment',
            \Doctrine\DBAL\Types\Type::getType( 'integer' ), array() );
        $diff->removedColumns['parent'] = new \Doctrine\DBAL\Schema\Column( 'comment',
            \Doctrine\DBAL\Types\Type::getType( 'integer' ), array() );
