...
abstract class AbstractMySQLPlatformTestCase extends AbstractPlatformTestCase
{
    ...
    public function testCreateTableWithFulltextIndex()
    {
        ...
        $sql = $this->_platform->getCreateTableSQL( $table );
        $this->assertEquals( array( 'CREATE TABLE fulltext_table (text LONGTEXT NOT NULL, FULLTEXT INDEX fulltext_text (text)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = MyISAM' ),
            $sql );
    }
    ...
    public function testCreateTableWithSpatialIndex()
    {
        ...
        $sql = $this->_platform->getCreateTableSQL( $table );
        $this->assertEquals( array( 'CREATE TABLE spatial_table (point LONGTEXT NOT NULL, SPATIAL INDEX spatial_text (point)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = MyISAM' ),
            $sql );
    }
    ...
    public function testClobTypeDeclarationSQL()
    {
        ...
        $this->assertEquals( 'MEDIUMTEXT',
            $this->_platform->getClobTypeDeclarationSQL( array( 'length' => 16777215 ) ) );
    ...
    public function testBlobTypeDeclarationSQL()
    {
        ...
        $this->assertEquals( 'MEDIUMBLOB',
            $this->_platform->getBlobTypeDeclarationSQL( array( 'length' => 16777215 ) ) );
    ...
    public function testReturnsBinaryTypeDeclarationSQL()
    {
        ...
        $this->assertSame( 'VARBINARY(65535)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'length' => 65535 ) ) );
        $this->assertSame( 'MEDIUMBLOB', $this->_platform->getBinaryTypeDeclarationSQL( array( 'length' => 65536 ) ) );
        $this->assertSame( 'MEDIUMBLOB',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'length' => 16777215 ) ) );
