...
class DB2PlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesColumnTypesDeclarationSQL()
    {
        ...
        $this->assertEquals( 'SMALLINT GENERATED BY DEFAULT AS IDENTITY',
        ...
        $this->assertEquals( 'INTEGER GENERATED BY DEFAULT AS IDENTITY',
        ...
        $this->assertEquals( 'BIGINT GENERATED BY DEFAULT AS IDENTITY',
        ...
        $this->assertEquals( 'TIMESTAMP(0) WITH DEFAULT',
    ...
    public function testGeneratesSQLSnippets()
    {
        ...
        $this->assertEquals( 'LOCATE(substring_column, string_column)',
            $this->_platform->getLocateExpression( 'string_column', 'substring_column' ) );
        $this->assertEquals( 'LOCATE(substring_column, string_column)',
            $this->_platform->getLocateExpression( 'string_column', 'substring_column' ) );
        $this->assertEquals( 'LOCATE(substring_column, string_column, 1)',
    ...
    public function testReturnsBinaryTypeDeclarationSQL()
    {
        ...
        $this->assertSame( 'VARBINARY(32704)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'length' => 32704 ) ) );
        ...
        $this->assertSame( 'BINARY(32704)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true, 'length' => 32704 ) ) );
        $this->assertSame( 'BLOB(1M)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true, 'length' => 32705 ) ) );
    }
