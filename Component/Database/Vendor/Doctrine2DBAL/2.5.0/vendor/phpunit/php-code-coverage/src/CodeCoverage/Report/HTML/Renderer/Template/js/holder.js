...
(function( app, win )
{
    ...
    function draw_canvas( args )
    {
        ...
        if (literal) {
            ...
            if (exact && holder.exact_dimensions) {
            ...
            if (mode == "background") {
                ...
                if (mode == "fluid") {
                    ...
                    if (dimensions.height.slice( -1 ) == "%") {
                        ...
                        if (holder.auto == null || !holder.auto) {
                            el.style.height = dimensions.height + "px"
                        }
                    }
        ...
        if (typeof (options.images) == "string") {
            ...
            if (window.NodeList && options.images instanceof window.NodeList) {
                ...
                if (window.Node && options.images instanceof window.Node) {
                    ...
                    if (window.HTMLCollection && options.images instanceof window.HTMLCollection) {
                        imageNodes = options.images
                    }
                }
            }
...
//http://javascript.nwbox.com/ContentLoaded by Diego Perini with modifications
    function contentLoaded( n, t )
    {
        ...
        {
            (e.type != s || i.readyState == l) && ((e.type == "load" ? n : i)[v]( f + e.type, r,
                u ), !h && (h = !0) && t.call( n, null ))
        }, o = function()
        {
            try {
                a.doScroll( "left" )
...
//https://gist.github.com/991057 by Jed Schmidt with modifications
    ...
    {
        var a = a.match( /^(\W)?(.*)/ ), b = b || document, c = b["getElement" + (a[1] ? "#" == a[1] ? "ById" : "sByClassName" : "sByTagName")], d = c.call( b,
            a[2] ), e = [];
