...
DOCBLOCK;
    ...
    public function testAnnotationWithVarType( $attribute, $value )
    {
        ...
        $docblock = sprintf( '@Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithVarType(%s = %s)', $attribute,
            $value );
        $parser->setTarget( Target::TARGET_PROPERTY );
    ...
    public function testAnnotationWithVarTypeError( $attribute, $type, $value, $given )
    {
        ...
        try {
            ...
            $this->assertContains( "[Type Error] Attribute \"$attribute\" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithVarType declared on property SomeClassName::invalidProperty. expects a(n) $type, but got $given.",
                $exc->getMessage() );
        }
    }
    ...
    public function testAnnotationWithVarTypeArrayError( $attribute, $type, $value, $given )
    {
        ...
        try {
            ...
            $this->assertContains( "[Type Error] Attribute \"$attribute\" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithVarType declared on property SomeClassName::invalidProperty. expects either a(n) $type, or an array of {$type}s, but got $given.",
                $exc->getMessage() );
        }
    }
    ...
    public function testAnnotationWithAttributes( $attribute, $value )
    {
        ...
        $parser = $this->createTestParser();
        $context = 'property SomeClassName::$invalidProperty.';
        $docblock = sprintf( '@Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithAttributes(%s = %s)',
            $attribute, $value );
        $parser->setTarget( Target::TARGET_PROPERTY );
    ...
    public function testAnnotationWithAttributesError( $attribute, $type, $value, $given )
    {
        ...
        try {
            ...
            $this->assertContains( "[Type Error] Attribute \"$attribute\" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithAttributes declared on property SomeClassName::invalidProperty. expects a(n) $type, but got $given.",
                $exc->getMessage() );
        }
    }
    ...
    public function testAnnotationWithAttributesWithVarTypeArrayError( $attribute, $type, $value, $given )
    {
        ...
        try {
            ...
            $this->assertContains( "[Type Error] Attribute \"$attribute\" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithAttributes declared on property SomeClassName::invalidProperty. expects either a(n) $type, or an array of {$type}s, but got $given.",
                $exc->getMessage() );
        }
    }
    ...
    public function testAnnotationWithRequiredAttributes()
    {
        ...
        $this->assertTrue( sizeof( $result ) === 1 );
        $this->assertInstanceOf( 'Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithRequiredAttributes',
            $result[0] );
        $this->assertEquals( "Some Value", $result[0]->getValue() );
        $this->assertInstanceOf( 'Doctrine\Tests\Common\Annotations\Fixtures\AnnotationTargetAnnotation',
            $result[0]->getAnnot() );
        ...
        try {
            ...
            $this->assertContains( 'Attribute "annot" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithRequiredAttributes declared on property SomeClassName::invalidProperty. expects a(n) Doctrine\Tests\Common\Annotations\Fixtures\AnnotationTargetAnnotation. This value should not be null.',
                $exc->getMessage() );
        }
        ...
        try {
            ...
            $this->assertContains( 'Attribute "value" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithRequiredAttributes declared on property SomeClassName::invalidProperty. expects a(n) string. This value should not be null.',
                $exc->getMessage() );
        }
    ...
    public function testAnnotationWithRequiredAttributesWithoutContructor()
    {
        ...
        $this->assertTrue( sizeof( $result ) === 1 );
        $this->assertInstanceOf( 'Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithRequiredAttributesWithoutContructor',
            $result[0] );
        ...
        try {
            ...
            $this->assertContains( 'Attribute "annot" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithRequiredAttributesWithoutContructor declared on property SomeClassName::invalidProperty. expects a(n) Doctrine\Tests\Common\Annotations\Fixtures\AnnotationTargetAnnotation. This value should not be null.',
                $exc->getMessage() );
        }
        ...
        try {
            ...
            $this->assertContains( 'Attribute "value" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithRequiredAttributesWithoutContructor declared on property SomeClassName::invalidProperty. expects a(n) string. This value should not be null.',
                $exc->getMessage() );
        }
    ...
    public function testSupportClassConstants( $docblock, $expected )
    {
        ...
        $result = $parser->parse( $docblock );
        $this->assertInstanceOf( '\Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithConstants',
            $annotation = $result[0] );
...
DOCBLOCK;
    ...
    public function testAutoloadAnnotation()
    {
        ...
        $this->assertFalse( class_exists( 'Doctrine\Tests\Common\Annotations\Fixture\Annotation\Autoload', false ),
            'Pre-condition: Doctrine\Tests\Common\Annotations\Fixture\Annotation\Autoload not allowed to be loaded.' );

        $parser = new DocParser();

        AnnotationRegistry::registerAutoloadNamespace( 'Doctrine\Tests\Common\Annotations\Fixtures\Annotation',
            __DIR__.'/../../../../' );
