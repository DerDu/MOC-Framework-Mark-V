...
abstract class AbstractPostgreSqlPlatformTestCase extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesForeignKeySqlForNonStandardOptions()
    {
        ...
        $foreignKey = new \Doctrine\DBAL\Schema\ForeignKeyConstraint(
            array('foreign_id'), 'my_table', array('id'), 'my_fk',
    ...
    public function testGeneratesSqlSnippets()
    {
        ...
        $this->assertEquals('SUBSTRING(column FROM 5)', $this->_platform->getSubstringExpression('column', 5),
            'Substring expression without length is not correct');
        $this->assertEquals('SUBSTRING(column FROM 1 FOR 5)', $this->_platform->getSubstringExpression('column', 1, 5),
