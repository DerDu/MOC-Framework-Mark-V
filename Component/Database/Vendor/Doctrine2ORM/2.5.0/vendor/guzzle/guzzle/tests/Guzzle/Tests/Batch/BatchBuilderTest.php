...
class BatchBuilderTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testTransfersRequests()
    {
        ...
        $this->assertInstanceOf( 'Guzzle\Batch\BatchRequestTransfer',
            $this->readAttribute( $batch, 'transferStrategy' ) );
    }
    ...
    public function testTransfersCommands()
    {
        ...
        $this->assertInstanceOf( 'Guzzle\Batch\BatchCommandTransfer',
            $this->readAttribute( $batch, 'transferStrategy' ) );
    }
}
