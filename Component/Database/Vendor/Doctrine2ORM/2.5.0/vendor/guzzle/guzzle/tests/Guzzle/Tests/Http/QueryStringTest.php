...
class QueryStringTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testToString()
    {
        ...
        $this->q->replace( $params );
        $this->assertEquals( 'test=value&test%202=this%20is%20a%20test%3F&test3%5B0%5D=v1&test3%5B1%5D=v2&test3%5B2%5D=v3&test4',
            $this->q->__toString() );
        $this->q->useUrlEncoding( false );
        $this->assertEquals( 'test=value&test 2=this is a test?&test3[0]=v1&test3[1]=v2&test3[2]=v3&test4',
            $this->q->__toString() );
