...
class InputDefinitionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructorArguments()
    {
        ...
        $this->assertEquals( array(), $definition->getArguments(),
    ...
    public function testGetOptionDefaults()
    {
        ...
        $definition = new InputDefinition( array(
            ...
            new InputOption( 'foo7', null, InputOption::VALUE_OPTIONAL | InputOption::VALUE_IS_ARRAY, '',
                array( 1, 2 ) ),
        ) );
        $defaults = array(
            'foo1' => null,
        ...
        $this->assertEquals( $defaults, $definition->getOptionDefaults(),
