...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDuplicate()
    {
        ...
        $request = new Request( array( 'foo' => 'bar' ), array( 'foo' => 'bar' ), array( 'foo' => 'bar' ), array(),
            array(), array( 'HTTP_FOO' => 'bar' ) );
    ...
    public function testGetHost()
    {
        ...
        $request->initialize( array(), array(), array(), array(), array(),
            array( 'HTTP_HOST' => 'www.example.com:8080' ) );
    ...
    public function testCreateFromGlobals( $method )
    {
        ...
        $this->assertEquals( array( 'bar4' ), $request->files->get( 'foo4' ),
    ...
    public function testGetLanguages()
    {
        ...
        $this->assertEquals( array( 'en', 'zh', 'en_US' ),
