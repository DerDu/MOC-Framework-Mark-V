...
$_POST['Username'] = new UsernameParameter( 'root' );
$_POST['Password'] = new PasswordParameter( 'kuw' );
$_POST['Database'] = new DatabaseParameter( 'ziel2' );
...
$Route->setParameterDefault( 'Driver', new DriverParameter( 'pdo_mysql' ) );
$Route->setParameterDefault( 'Host', new HostParameter( '192.168.100.204' ) );
$Route->setParameterDefault( 'Port', new PortParameter( '3306' ) );
