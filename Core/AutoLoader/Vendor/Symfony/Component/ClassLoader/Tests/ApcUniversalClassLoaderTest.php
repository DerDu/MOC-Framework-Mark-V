...
class ApcUniversalClassLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals( $loader->findFile( '\Apc\Namespaced\FooBar' ),
            apc_fetch( 'test.prefix.\Apc\Namespaced\FooBar' ), '__construct() takes a prefix as its first argument' );
    }
