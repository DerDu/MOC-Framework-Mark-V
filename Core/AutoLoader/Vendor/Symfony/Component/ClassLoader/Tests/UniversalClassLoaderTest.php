...
class UniversalClassLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testUseIncludePath()
    {
        ...
        $this->assertEquals( __DIR__.DIRECTORY_SEPARATOR.'Fixtures'.DIRECTORY_SEPARATOR.'includepath'.DIRECTORY_SEPARATOR.'Foo.php',
            $loader->findFile( 'Foo' ) );
    ...
    public function testRegisterNamespaceFallback()
    {
        ...
        $this->assertEquals( array( __DIR__.DIRECTORY_SEPARATOR.'Fixtures/Namespaced/fallback' ),
            $loader->getNamespaceFallbacks() );
    }
