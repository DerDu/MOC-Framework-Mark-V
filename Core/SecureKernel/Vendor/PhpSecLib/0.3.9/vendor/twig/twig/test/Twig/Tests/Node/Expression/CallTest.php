...
class Twig_Tests_Node_Expression_CallTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetArguments()
    {
        ...
        $this->assertEquals(array('U', null),
            $node->getArguments('date', array('format' => 'U', 'timestamp' => null)));
    }
    ...
    public function testResolveArgumentsWithMissingValueForOptionalArgument()
    {
        ...
        $node = new Twig_Tests_Node_Expression_Call(array(),
            array('type' => 'function', 'name' => 'substr_compare'));
    ...
    public function testResolveArgumentsOnlyNecessaryArgumentsForCustomFunction()
    {
        ...
        $node = new Twig_Tests_Node_Expression_Call(array(),
            array('type' => 'function', 'name' => 'custom_function'));

        $this->assertEquals(array('arg1'),
            $node->getArguments(array($this, 'customFunction'), array('arg1' => 'arg1')));
    }
    ...
    public function testGetArgumentsForStaticMethod()
    {
        ...
        $node = new Twig_Tests_Node_Expression_Call(array(),
            array('type' => 'function', 'name' => 'custom_static_function'));
        $this->assertEquals(array('arg1'),
            $node->getArguments(__CLASS__.'::customStaticFunction', array('arg1' => 'arg1')));
    }
