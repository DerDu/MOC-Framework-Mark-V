!function()
{
    ...
    function W(e)
    {
        var r = ".dragsuppress-" + ++Aa, u = "click" + r, i = ta.select(t(e)).on("touchmove" + r,
            S).on("dragstart" + r, S).on("selectstart" + r, S);
        ...
        function e(n, t, e, r)
        {
            for (var u, i, o, a = 0, c = t.length, l = e.length; c > a;) {
                ...
                if (u = t.charCodeAt(a++), 37 === u) {
                    if (o = t.charAt(a++), i = C[o in sc ? t.charAt(a++) : o], !i || (r = i(n, e,
                            r)) < 0) {
                        return -1
                    }
                } else {
    ...
    function He(n)
    {
        ...
        function e(n)
        {
            ...
            return {
                ...
                {
                    var g, p = [f, h], v = t(f, h), d = o ? v ? 0 : u(f, h) : v ? u(f + (0 > f ? qa : -qa),
                        h) : 0;
    ...
    function nr(n)
    {
        ...
        function u(t, e, r, a, c, l, s, f, h, g, p, v, d, m)
        {
            ...
            if (x > 4 * i && d--) {
                ...
                (L * L / x > i || ga((y * z + M * q) / x - .5) > .3 || o > a * g + c * p + l * v) && (u(t, e, r, a,
                    c, l, N, C, E, b /= S, _ /= S, w, d, m), m.point(N, C), u(N, C, E, b, _, w, s, f, h, g, p, v, d,
                    m))
            }
        }
    ...
    function $r(n)
    {
        for (var t, e = Gc, r = Oe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--;) {
            t = e[u], (!Br(t,
                n) || !r(t) || ga(t.a.x - t.b.x) < Ca && ga(t.a.y - t.b.y) < Ca) && (t.a = t.b = null, e.splice(u,
                1))
        }
    }
        ...
        if ((e = n.children) && (l = e.length)) {
            ...
            if (e.forEach(xi), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), l > 2)) {
                for (i = e[2], wi(r,
                    ...
                    p ? (d > v || v == d && u.r < r.r ? mi(r, u = a) : mi(r = c, u), o--) : (di(r,
                        i), u = i, t(i))
                }
            }
    ...
    {
        null == t && (t = 10);
        var e = Pi(n), r = e[1] - e[0], u = Math.pow(10,
    ...
    function So(n)
    {
        ...
        for (n.push(n[e - 1]); ++t <= e;) {
            r = n[t], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), Co(c, o,
                a);
        }
    ...
    function Co(n, t, e)
    {
        n.push("C", No(Al, t), ",", No(Al, e), ",", No(Nl, t), ",", No(Nl, e), ",", No(Cl, t), ",",
            No(Cl, e))
    }
    ...
    function Go(n, t, e)
    {
        ...
        {
            var e = Pi(r.domain()), i = null == n ? u(e, 10) : "number" == typeof n ? u(e,
                n) : !n.range && [{range: n}, t];
    ...
    }, ta.behavior.drag = function()
    {
            ...
            return function()
            {
                ...
                function c()
                {
                    t(h, v) && (m.on(i + d, null).on(o + d,
                        null), y(p && ta.event.target === f), g({type: "dragend"}))
                }
        ...
        var r = E(n, "drag", "dragstart", "dragend"), u = null, i = e(b, ta.mouse, t, "mousemove",
            "mouseup"), o = e(G, ta.touch, y, "touchmove", "touchend");
    ...
    }, ta.behavior.zoom = function()
    {
        ...
        function f()
        {
            ...
            var u = this, o = ta.event.target, a = D.of(u, arguments), f = 0, h = ta.select(t(u)).on(L,
                n).on(T, r), g = e(ta.mouse(u)), p = W(u);
            Dl.call(u), c(a)
        }
    ...
    }, Jc.clip = function(n)
    {
        for (var t, e, r, u, i, o, a = Tr(n), c = -1, l = this.length - Tr(this), s = this[l - 1]; ++c < l;) {
            for (t = n.slice(), n.length = 0, u = this[c], i = t[(r = t.length - a) - 1], e = -1; ++e < r;) {
                o = t[e], qr(o,
                    s, u) ? (qr(i, s, u) || n.push(Lr(i, o, s, u)), n.push(o)) : qr(i, s,
                    u) && n.push(Lr(i, o,
                    s, u)), i = o;
            }
            a && n.push(n[0]), s = u
    ...
    }, ta.layout.force = function()
    {
        ...
        }, a.drag = function()
        {
            return e || (e = ta.behavior.drag().origin(y).on("dragstart.force", Xu).on("drag.force",
                t).on("dragend.force", $u)), arguments.length ? void this.on("mouseover.force",
                Bu).on("mouseout.force", Wu).call(e) : e
        }, ta.rebind(a, c, "on")
    };
    ...
    }, ta.svg = {}, ta.svg.arc = function()
    {
        function n()
        {
            ...
            if ((m = (+c.apply(this,
                        arguments) || 0) / 2) && (d = i === kl ? Math.sqrt(n * n + l * l) : +i.apply(this,
        ...
        function n(n)
        {
            n.each(function()
            {
                var n, l = ta.select(this), s = this.__chart__ || e, f = this.__chart__ = e.copy(), h = null == c ? f.ticks ? f.ticks.apply(f,
                    ...
                    a) : y : t, p = l.selectAll(".tick").data(h, f), v = p.enter().insert("g",
                    ".domain").attr("class", "tick").style("opacity",
                    Ca), d = ta.transition(p.exit()).style("opacity",
    ...
    ta.svg.brush = function()
    {
        function n(t)
        {
            t.each(function()
            {
                ...
                l && (c = Ui(l), h.attr("x", c[0]).attr("width",
                    c[1] - c[0]), r(f)), s && (c = Ui(s), h.attr("y", c[0]).attr("height",
                    c[1] - c[0]), u(f)), e(f)
            })
        }
        ...
        function r(n)
        {
            n.select(".extent").attr("x", f[0]), n.selectAll(".extent,.n>rect,.s>rect").attr("width",
                f[1] - f[0])
        }

        function u(n)
        {
            n.select(".extent").attr("y", h[0]), n.selectAll(".extent,.e>rect,.w>rect").attr("height",
                h[1] - h[0])
        }
        ...
        function i()
        {
            ...
            var M, x, b = this, _ = ta.select(ta.event.target), w = c.of(b,
                ...
                i).on("keyup.brush", v);
            if (ta.event.changedTouches ? L.on("touchmove.brush", d).on("touchend.brush",
                    y) : L.on("mousemove.brush", d).on("mouseup.brush",
