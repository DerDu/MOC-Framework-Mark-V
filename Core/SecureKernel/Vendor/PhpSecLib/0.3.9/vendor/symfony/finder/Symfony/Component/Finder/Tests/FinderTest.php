...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testDirectories($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'toto')),
    ...
    public function testInWithGlob($adapter)
    {
        ...
        $this->assertIterator($this->toAbsoluteFixtures(array('A/B/C/abc.dat', 'copy/A/B/C/abc.dat.copy')),
            $finder);
    }
    ...
    public function testAppendReturnsAFinder($adapter)
    {
        ...
        $this->assertInstanceOf('Symfony\\Component\\Finder\\Finder',
            $this->buildFinder($adapter)->append(array()));
    }
